    ...
    return (
        <div className="w-full relative min-h-screen">
            <header className="py-4 mb-6 text-center border-b border-white/10 flex flex-col items-center">
                ...
                >
                    <img src="/waifudle_logo.png" alt="WaifuDLE" className="h-16 md:h-24 object-contain drop-shadow-xl animate-pop-in smooth-render hover:brightness-110 transition-all" />
                </button>
            ...
            <main className="flex-grow pb-20">
                ...
                <div className={`relative z-50 transition-all duration-300 ${turn === 'player' && phase === 'playing' ? 'opacity-100 translate-y-0' : 'opacity-50 pointer-events-none translate-y-2'}`}>
